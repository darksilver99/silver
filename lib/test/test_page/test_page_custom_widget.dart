...
class TestPageCustomWidget extends StatefulWidget {
  ...
  @override
  _TestPageCustomWidgetState createState() => _TestPageCustomWidgetState();
}

class _TestPageCustomWidgetState extends State<TestPageCustomWidget> {
  XFile? _pickedFile;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: !kIsWeb ? AppBar(title: Text("aaa")) : null,
      body: Column(

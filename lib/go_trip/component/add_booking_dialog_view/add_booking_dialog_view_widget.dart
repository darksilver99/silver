...
import 'add_booking_dialog_view_model.dart';
...
class _AddBookingDialogViewWidgetState
    extends State<AddBookingDialogViewWidget> {
  late AddBookingDialogViewModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AddBookingDialogViewModel());

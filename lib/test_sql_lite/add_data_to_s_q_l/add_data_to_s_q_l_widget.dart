...
import 'add_data_to_s_q_l_model.dart';
...
class _AddDataToSQLWidgetState extends State<AddDataToSQLWidget> {
  late AddDataToSQLModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AddDataToSQLModel());
